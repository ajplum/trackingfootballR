...
#'
#' @description Retrieve Tracking Football player details since a given date.
...
#' @examples
#' \dontrun{
#' ncaa_historical <- get_all_player_details(api_key, updated_since = "2020-01-01", player_type = "college")
#' }
#' @export
#'
#' @import httr
...
get_all_player_details <- function(api_key,
